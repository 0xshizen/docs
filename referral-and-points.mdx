...
<CardGroup cols={2}>
  <Card title="Total Team Stake" icon="coins">
    Refers to the total amount of SOL you and your friends have staked in Stellium.
  </Card>
  <Card title="Total Commission" icon="percent">
    The percentage of block rewards you earn together, applied to your referees’ total stake.
  </Card>
</CardGroup>

| Tier | Name | Total Team Stake (SOL) | Total Commission | Custom Referral Code |
|------|------|-------------------|------------------|---------------------|
| 1 | Starter | 0.1 | 20% | ❌ |
| 2 | Builder | 100 | 25% | ❌ |
| 3 | Booster | 300 | 30% | ❌ |
...
<Tip>
Connect your **X** account if you’ve got **1,000+ followers**, you’ll land in the Booster tier and get your own referral code.
</Tip>
...
- The referee percentage on a referral code can only stay the same or increase—once set, it can never be lowered
...
You will get additional boost when you trade on Raydium Aggregator.
