...
Submit a transaction to Solana network through Stellium's optimized transaction landing service.
...
1. Each transaction must include a system transfer instruction to one of the Stellium tip addresses with a minimum tip of 0.001 SOL
